    ...
    <div>
      <Header></Header>
        <MainPageLayout flexcol="md:flex-col"> 
            <h1 className='md:text-6xl justify-self-start self-start text-plate-white md:mb-[2rem] text-4xl my-[2rem] mb-[6rem] md:my-0'>Products</h1>
          {
              data.map((products) => {
                return (
                  <div key={products.id} 
                  ...
                  ${(products.id === 1) ? 'md:mt-[10rem]' : ''} `}>
                    <div className='md:mt-[4rem] mb-8 md:mb-0'>
